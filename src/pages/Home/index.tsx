...
export default function HomePage() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setFormStatus('error');
      setFormError(err instanceof Error ? err.message : 'Form submission failed');
    }
  };
                        ...
                        {formStatus === 'error' && (
                            ...
                            >
                                Something went wrong. Please try again, or call/text us.
                                    ...
                                    {formStatus === 'success' && (
                        <p className="text-green-400 font-semibold">Thanks — your message was sent.</p>
                    )}
                    {formStatus === 'error' && (
                        <p className="text-red-400 font-semibold">Sorry — something went wrong. {formError}</p>
                    )}
</form>
            </div>
        </div>
