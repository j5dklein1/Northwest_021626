...
export default function HomePage() {
  ...
  // Contact form uses standard HTML POST so it works reliably across browsers
  // and does not depend on client-side JavaScript.
        ...
        <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto bg-card border border-white/10 p-8 md:p-12 shadow-2xl rounded-sm">
                <div className="text-center mb-10">
	                ...
	                <form name="contact" method="POST" action="/thank-you.html" data-netlify="true" netlify-honeypot="bot-field" className="space-y-6">
